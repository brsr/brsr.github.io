...
Let the triangle have vertices $$\mathbf{\hat{a}}$$, $$\mathbf{\hat{b}}$$, and $$\mathbf{\hat{c}}$$, oriented counterclockwise. See the earlier post for more details on spherical geometry using vectors.
