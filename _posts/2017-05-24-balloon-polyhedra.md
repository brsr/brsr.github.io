...
With some shifting of the vertices of such polyhedron, the regular part of the polyhedron could be enlarged and the irregular part shrinked. Of course, there are significant differences in aspect ratio and size between the faces of these polyhedra. The result also resembles the [stereographic projection](https://en.wikipedia.org/wiki/Stereographic_projection) of a triangular or square grid, but without an infinite number of vertices collecting near one of the poles.
